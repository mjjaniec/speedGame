...
public class NewAccountActivity extends AbstractActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.newaccount__avatar).setEnabled(false);
        findViewById(R.id.newaccount__ring).setEnabled(false);

        if (update) {
            login.setEnabled(false);
            login.setText(UsersController.getInstance().getCurrent().getName());
            setStr(R.id.newaccount__avatar, "");
            setStr(R.id.newaccount__ring, "");
            setStr(R.id.newaccount__register, R.string.newaccount__update);
        }
        ...
        findViewById(R.id.newaccount__change_avatar).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AppController.getInstance().setCallback(
                        new FieldSetter((TextView) findViewById(R.id.newaccount__avatar), avatar));
        ...
        findViewById(R.id.newaccount__change_ring).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AppController.getInstance().setCallback(
                        new FieldSetter((TextView) findViewById(R.id.newaccount__ring), ring));
        ...
        switch (result) {
            case OK:
                UsersController.getInstance().addUser(new User(
                        getStr(R.id.newaccount__login), this));
